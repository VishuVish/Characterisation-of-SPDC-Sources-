...
def process_file(file_path, is_coincidence):
    with open(file_path, 'r') as file:
        lines = file.readlines()[5:]  # Skip first 5 lines
...
if __name__ == "__main__":
    folder_path = "C:/Users/vishn/OneDrive/Desktop/FSU Jena/University of Jena/1st Sem/Quantum Laboratory/Reports/Lab 06 SPDC/EQT WS24/EXP 2/dark count"
    main(folder_path)